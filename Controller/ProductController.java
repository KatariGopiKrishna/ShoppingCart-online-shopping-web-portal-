...
public class ProductController {
	...
	public String addBook(HttpServletRequest request, @Valid @ModelAttribute("Product") Product product,BindingResult result) {
		if (result.hasErrors()) {
	...
	public ModelAndView display12() {
		ModelAndView m10 = new ModelAndView("UserHome");
		return m10;
	}
...
public ModelAndView display9(){
	...
	public ModelAndView ShowPro(@RequestParam int id, @ModelAttribute Product products) {
		Product product = pd.get(id);
