...
<h1><span style=padding-left:20px><a href="ref"><img src="<c:url value="/resources/images/log.png"/>" width="50" height="50"><font  face="Gadget" size="40" color="white">Cameron</font> <i> <sub><font face="Gadget" color="black">for unseen photography...!!</a></font></sub>
</span></h1></ul></div>
...
<nav class="navbar navbar-inverse navbar-top">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li><a href="Contact">ContactUs</a></li></ul>
...
<iframe width=450px height=300px src="https://www.youtube.com/embed/8Z9089048wk" frameborder="0" allowfullscreen></iframe></span>
<br><br>
 ...
 <div class="mydiv">
  ...
  <div class="row">
    <div class="col-sm-4">
          <br><br><br>
       <span style=padding-left:20px> <a href="Products"><img src="<c:url value="/resources/images/cam01.jpg"/>" alt="Pulpit Rock" style="width:300px;height:150px"></a>
            </span> </div><br><br><br>
    <div class="col-sm-4">
           
        <a href="Products"> <img src="<c:url value="/resources/images/cam02.jpg"/>" alt="Mustiers Sainte Marie" style="width:300px;height:150px">
         
    </div>
    <div class="col-sm-4">
      <a href="enter pro?data=table">
          <a href="Products"> <img src="<c:url value="/resources/images/cam08.jpg"/>" alt="Cinque Terre" style="width:300px;height:150px">
      </a>
...
<footer class="container-fluid text-center">
	<p><br><br><font color=white>Copy Rights©Cameron-All Rights Reserved
		2016</font></P>
